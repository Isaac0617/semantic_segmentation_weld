...
class DeeplabV3(object):
    _defaults = {
        ...
        #-------------------------------------------------------------------#
        "model_path"        : '/home/nvidia/data_1t/sds_ws/ros_ws/src/py_seg/script/model_data/weights0823.pth',
        # "model_path": '/home/nvidia/data_1t/sds_ws/ros_ws/src/py_seg/script/model_data/deeplab_mobilenetv2.pth',
        #----------------------------------------#
        #   所需要区分的类的个数+1
        #----------------------------------------#
        "num_classes"       : 2,
